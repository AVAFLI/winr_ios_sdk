...
WINR is distributed via **Swift Package Manager**:

### Xcode

1. **File → Add Package Dependencies…**
2. Enter the repository URL: `https://github.com/AVAFLI/winr_ios_sdk.git`
3. Set dependency rule to **Up to Next Major Version** from `2.2.0`
...
```swift
dependencies: [
    .package(url: "https://github.com/AVAFLI/winr_ios_sdk.git", from: "2.2.0")
]
```

> **CocoaPods:** A podspec is included in the repo, but the pod is not yet published to the CocoaPods trunk — use Swift Package Manager for now.
