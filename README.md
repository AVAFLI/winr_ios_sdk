...
[![CocoaPods](https://img.shields.io/badge/CocoaPods-2.9.1-red.svg)](https://cocoapods.org/pods/WINRSDK)
...
3. Set dependency rule to **Up to Next Major Version** from `2.9.1`
...
```swift
dependencies: [
    .package(url: "https://github.com/AVAFLI/winr_ios_sdk.git", from: "2.9.1")
]
```
